...
<!-- -->
    ...
    <div class="section no-pad-bot">
      <div class="container">
        ...
        <div class="row center">
          <h2 class="header col s12  grey-text">Luttons contre le gaspillage alimentaire</h2>
        </div>
        <div class="row center">
          <a href="#" id="download-button" class="btn-large waves-effect waves-light grey darken-2">S'inscrire</a>
        </div>
        <br><br>
  ...
  <div class="parallax-container valign-wrapper">
    ...
    <div class="parallax"><img src="core/img/background2.jpg" alt="Unsplashed background img 2"></div>
  </div>
